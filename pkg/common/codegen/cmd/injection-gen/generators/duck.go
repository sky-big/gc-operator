...
func (g *duckGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"injectionRegisterDuck":     c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/common/injection", Name: "Default.RegisterDuck"}),
		"getResyncPeriod":           c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/common/controller", Name: "GetResyncPeriod"}),
		"dynamicGet":                c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/common/injection/clients/dynamicclient", Name: "Get"}),
		"duckTypedInformerFactory":  c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/apis/duck", Name: "TypedInformerFactory"}),
		"duckCachedInformerFactory": c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/apis/duck", Name: "CachedInformerFactory"}),
		"duckInformerFactory":       c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/apis/duck", Name: "InformerFactory"}),
		"loggingFromContext": c.Universe.Function(types.Name{
			Package: "github.com/sky-big/gc-operator/pkg/common/logging",
			Name:    "FromContext",
		}),
	}
