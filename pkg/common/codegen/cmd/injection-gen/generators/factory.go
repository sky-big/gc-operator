...
func (g *factoryGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"injectionRegisterInformerFactory":             c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/common/injection", Name: "Default.RegisterInformerFactory"}),
		"injectionHasNamespace":                        c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/common/injection", Name: "HasNamespaceScope"}),
		"injectionGetNamespace":                        c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/common/injection", Name: "GetNamespaceScope"}),
		"controllerGetResyncPeriod":                    c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/common/controller", Name: "GetResyncPeriod"}),
