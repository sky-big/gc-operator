...
func (g *injectionGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"injectionRegisterInformer": c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/common/injection", Name: "Default.RegisterInformer"}),
		"controllerInformer":        c.Universe.Type(types.Name{Package: "github.com/sky-big/gc-operator/pkg/common/controller", Name: "Informer"}),
